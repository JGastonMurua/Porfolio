(function () {
    ...
    const TRANSLATIONS = {
        es: {
            ...
            'proj.qa.desc': 'Suites de tests E2E con Playwright y Selenium sobre proyectos propios en producción (TechStore, GTresD). No son demos: corren contra los sitios reales, con CI en GitHub Actions, y encontraron bugs reales (un backend caído y un botón inaccesible por CSS).',
            ...
            'edu.qa.desc': 'Testing manual y automatizado de software con Playwright y Selenium.',
        ...
        en: {
            ...
            'proj.qa.desc': 'E2E test suites with Playwright and Selenium on my own projects in production (TechStore, GTresD). Not demos: they run against the real sites, with CI on GitHub Actions, and found real bugs (a downed backend and a button unreachable due to CSS).',
            ...
            'edu.qa.desc': 'Manual and automated software testing with Playwright and Selenium.',
